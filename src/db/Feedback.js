...
const recommendation = [
    ...
    {
      id: 3,
      text: 'I  have worked with Elizabeth at Micro-verse and her professionalism during meetings and punctuality are among her other outstanding traits. Elizabeth has strong problem-solving skills as well as excellent communication skills which are complementary to making her a great remote software developer. Any company that loves balance in project delivery would be happy to have her on their team.',
      image: IMG9,
    ...
    {
      id: 7,
      text: 'Elizabeth is one of the smartest software developers I’ve ever met. I worked alongside her at TIIDELab. During that time she showed her commitment and determination towards team building and making sure that technical projects comes into completion while meeting deadlines over. Elizabeth is a person who has exceptional leadership skills and has used that skill to impact those around her and the success of the team and projects.',
      image: IMG13,
      name: 'Victor Okoroji',
      location: 'Lagos, Nigeria'
    },
    ...
    {
      id: 8,
      text: 'Elizabeth is one of the brightest software developers I’ve ever met. I worked alongside her at TiideLab where she was instrumental in building amazing projects. Elizabeth is always challenging herself--she’s the type of person who reads documentation for fun, and her attention to detail is evident in all of the projects I’ve worked with her on. She’s also genuinely a kind, encouraging person.',
      image: IMG15,
